...
<head>
	...
	<script type="text/javascript">
	    ...
	    function showCCTV(location, index) {
            ...
            smoothPanTo(targetPosition, 20); // 18 is the desired zoom level
	    ...
	    <div id="content">
	        ...
	        <div style="height: auto; position: relative;" class="row shadow bg-white justify-content-center">
			    <div class="bg-secondary text-center tanggal_hari_ini">
			        <span class="h5 mb-0 font-weight-bold text-white tgl-hari-ini"><?= $now; ?></span>
			    </div>
			    <div class="bg-white text-center berita">
			        <marquee class="h5 mb-0 font-weight-bold text-gray-800 mt-0 text-berjalan">CCTV ONLINE MAGETAN PT SARANGAN SUKSES PERKASA</marquee>
			    </div>
			</div>
			...
			<div class="row bg-primary text-white pt-4">
			     <div class="container-fluid">
			        <div class="row mb-4">
			            ...
			            <div class="col-sm-4 text-center">
			                <span class="font-weight-bold mb-3" style="font-size: 18px;">Support by :</span>
			            </div>
			            <div class="col-sm-4 text-center">
			                <span class="font-weight-bold mb-3" style="font-size: 18px;">Sosial Media</span>
			                <div class="mt-2">
