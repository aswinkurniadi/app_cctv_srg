          ...
          <div class="col-lg">
            <?= form_open_multipart(''); ?>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="url_rtsp" name="url_rtsp" placeholder="Masukkan url_rtsp" required="">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="url_directory" class="col-sm-3">URL Directory</label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="url_directory" name="url_directory" placeholder="Masukkan url_directory" required="">
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    ...
                    <input type="hidden" class="form-control mb-2" id="latitude" name="latitude" placeholder="Masukkan latitude" readonly="" required="">
                    <input type="hidden" class="form-control mb-2" id="longitude" name="longitude" placeholder="Masukkan longitude" readonly="" required="">
                    <textarea class="form-control mb-2" id="almt" name="almt" rows="3" required readonly=""></textarea>
                  </div>
                </div>
                <div class="form-group row">
