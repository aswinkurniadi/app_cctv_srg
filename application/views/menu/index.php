						    ...
						    <tr>
						      ...
						      <?php if (is_admin()) : ?>
							      <td class="text-center" width="20%">
							      		<a href="<?= base_url(); ?>menu/sub_menu/<?= $row['id_menu']; ?>" class="badge badge-success" >
      ...
      <form action="<?= base_url('menu/add'); ?>" method="post">
      	<div class="modal-body">
      		<div class="form-group row">
                <label for="nama" class="col-sm-5 col-form-label">Nama Menu</label>
                <div class="col-sm-7">
...
<div class="modal fade" id="updateMenu" tabindex="-1" role="dialog" aria-labelledby="updateMenuLabel" aria-hidden="true" >
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="updateMenuLabel">Ubah Menu</h5>
      </div>
